...
You can use this method for any type of text based art, so that everyone can enjoy your <code class="hidden d-i" role="img" aria-label="internet aesthetic">i̐̽͑n͊̕͝ẗ́͊͒e̒̀̓r͊͒͊n̿̔͝e̽̒͌t͌͝͝ a̼̝e͉͕͉s͓͓͓t͍͍̦h̼͖͜e̦̘̫ț͓͔i̝̞̟c̘͖</code>.
...
Copy the code below, add your art and change the `aria-label` and you will have made your website a more accessible!
