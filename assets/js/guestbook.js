...
const s_stylePath = '/css/pages/_guestbook.css'; // Define the path for the stylesheet (ie. /styles/commentwidget.css)
const s_formId = '1FAIpQLSfTnsuPhdTT7pwAg3VSSaNBGB7IfVft_r8jUTYWyYme_MXWGA'; // The Google Form
...
function displayComments(comments) {
    ...
    if (s_collapsedReplies) {
        ...
        for (i = 0; i < containers.length; i++) {
            ...
            button.className = 'c-expandButton button ghost';
